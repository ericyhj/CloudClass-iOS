...
extension AgoraUIManager {
    ...
    func layoutLectureContainerViews() {
        ...
        renderLecture.containerView.agora_safe_bottom = 0
    ...
    func layoutLectureView(_ isFullScreen: Bool) {
        ...
        let size = renderLecture.teacherViewSize
        let whiteBoardY = renderLecture.containerView.agora_safe_y
    ...
    private func resetLectureChatLayout(_ isFullScreen: Bool) {
        ...
        if isFullScreen {
            ...
            let renderLectureUserMaxY = renderLecture.containerView.agora_safe_y + size.height
            let chatHeight = kScreenHeight - safeSpace - renderLectureUserMaxY - ViewGap
